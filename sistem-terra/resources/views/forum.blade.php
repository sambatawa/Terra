    ...
    <div class="py-12 bg-[#F3F0FF]">
        <div class="max-w-3xl mx-auto sm:px-6 lg:px-8">
            ...
            <div class="{{ $cardClass }} overflow-hidden shadow-sm sm:rounded-lg mb-6 p-6">
                ...
                <p class="mt-4 text-gray-800 whitespace-pre-line leading-relaxed">{{ $post->content }}</p>
...
<script>
    ...
    // Fungsi untuk membuka/menutup dropdown share
    function toggleDropdown(id) {
        // Tutup semua dropdown lain dulu biar gak numpuk
